...
- Download from [this link](https://mitprod-my.sharepoint.com/:u:/g/personal/bbillot_mit_edu/Ebqxo6YgUmBJkOML0m8NSXgBrhaHG7iqClFXRXPinS6FGw?e=DzKf1p) (for reference only — please refer to the [SynthSeg repo](https://github.com/BBillot/SynthSeg) for the latest official source), **or**
