    ...
    for split in requested_splits:
        ...
        for mod in modalities:
            for field in fields:
                ...
                elif getattr(args, "max_subjects", 0) > 0:
                    nifti_files = nifti_files[:args.max_subjects]  # disk/time cap
...
def main():
    ...
    p_extract.add_argument("--max_subjects", type=int, default=0,
                           help="Extract at most N volumes per split/modality/field (0=all). "
                                "Use to bound disk usage; match it to data.max_train_subjects.")
